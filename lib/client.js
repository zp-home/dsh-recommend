...
`;
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						children: pageRows.map((p, i) => {
							...
							const securityLabel = p.verification?.staticSecurity?.status === "passed" ? t("securityPassed") : p.verification?.staticSecurity?.status === "warnings" ? t("securityWarnings", { risk: p.verification.staticSecurity.risk }) : t("securityUnavailable");
										...
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
											...
											children: [
												...
												/* @__PURE__ */ (0, react_jsx_runtime.jsx)("a", {
													className: "dshr-pill dshr-security-pill",
		...
		const zh = {
			...
			securityPassed: "静态提示：未匹配规则",
			securityWarnings: "静态提示（{risk}）",
		...
		const en = {
			...
			securityPassed: "Static advisory: no rule match",
			securityWarnings: "Static advisory ({risk})",
