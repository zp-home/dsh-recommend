				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						children: pageRows.map((p, i) => {
							...
							const securityLabel = security?.status === "passed" ? t("securityPassed") : security?.status === "warnings" ? security.risk === "high" ? t("securityWarningsHigh") : security.risk === "medium" ? t("securityWarningsMedium") : t("securityWarningsLow") : t("securityUnavailable");
							const securityClass = security?.status === "passed" ? "dshr-security-clear" : security?.status === "warnings" ? `dshr-security-${security.risk}` : "dshr-security-unavailable";
