...
`;
								...
								candidateSecurity.findings?.length ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("ul", {
									...
									children: candidateSecurity.findings.map((finding, index) => {
										...
										return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", { children: [
											...
											finding.family ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", { children: [
												t("securityFamily"),
												": ",
												finding.family
											] }) : null,
											finding.confidence ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", { children: [
												t("securityConfidence"),
												": ",
												finding.confidence
											] }) : null,
											finding.disposition ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", { children: [
												t("securityDisposition"),
												": ",
												finding.disposition
											] }) : null,
											finding.basis ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", { children: [
												t("securityBasis"),
												": ",
												finding.basis
											] }) : null,
											finding.remediation ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", { children: [
												t("securityRemediation"),
												": ",
												finding.remediation
											] }) : null,
											finding.baselineRisk ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", { children: [
												t("securityBaselineRisk"),
												": ",
												baselineRiskLabel
											] }) : null,
											finding.protections ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", { children: [
												t("securityProtections"),
												": ",
												finding.protections
											] }) : null,
											finding.downgrade ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", { children: [
												t("securityDowngrade"),
												": ",
												finding.downgrade
											] }) : null,
		...
		const zh = {
			...
			securityBaselineRisk: "初始风险",
			securityProtections: "已检测保护",
			securityDowngrade: "降级依据",
			riskLow: "低风险",
			riskMedium: "中风险",
			riskHigh: "高风险",
		...
		const en = {
			...
			securityBaselineRisk: "Baseline risk",
			securityProtections: "Detected protections",
			securityDowngrade: "Downgrade rationale",
			riskLow: "Low risk",
